...
def setup_llm_chain(topic = "technology"):
    prompt = ChatPromptTemplate.from_messages([
        ("system", "You are a joking AI. Give me only one funny joke."),
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Hello! I am your joke bot. Send me a topic and I'll tell you a joke!")
    
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("I am your joke bot. Send me a topic and I'll tell you a joke!")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if f'@{bot_username}' in msg:
        ...
        if match and match.group(1).strip():
            ...
            await update.message.reply_text("Please provide a topic after my username.")
